...
function rendreLignesClassement_(corps, classement) {
  ...
  if (!Array.isArray(classement)) {
    ...
    corps.innerHTML = `<tr><td colspan="5" class="note">Erreur : ${message}</td></tr>`;
    return;
  }
...
async function chargerClassement() {
  ...
  try {
    ...
    corps.innerHTML = '<tr><td colspan="5" class="note">Connexion au serveur impossible. Réessaie dans un instant.</td></tr>';
  }
}
